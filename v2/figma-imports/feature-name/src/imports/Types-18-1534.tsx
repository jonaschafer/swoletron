import svgPaths from "./svg-7z3ne456zg";
...
export default function Types() {
  return (
    <div className="bg-red-900 content-stretch flex flex-col gap-[20px] items-center justify-center overflow-clip relative rounded-[10px] size-full" data-name="types">
      <Frame3 />
    </div>
  );
}