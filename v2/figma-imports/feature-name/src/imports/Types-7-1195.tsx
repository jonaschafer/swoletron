import svgPaths from "./svg-blp86rv02b";
...
export default function Types() {
  return (
    <div className="bg-blue-600 content-stretch flex flex-col gap-[20px] items-center justify-center overflow-clip relative rounded-[10px] size-full" data-name="types">
      <Frame6 />
    </div>
  );
}