import svgPaths from "./svg-hsd686o8jc";
...
function Frame7() {
  return (
    <div className="bg-green-600 h-[76px] relative rounded-tl-[10px] rounded-tr-[10px] shrink-0 w-full">
      <Frame4 />
...
function Set() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] box-border content-stretch flex items-center justify-between px-[14px] py-[10px] relative rounded-[8px] shrink-0 size-[36px]" data-name="set">
...
function Rep() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] box-border content-stretch flex h-[36px] items-center justify-between overflow-clip px-[14px] py-[10px] relative rounded-[8px] shrink-0 w-[96px]" data-name="rep">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[14px] text-nowrap text-white">
...
function X() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="x">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="x">
          <path d={svgPaths.p2efb2b00} id="Vector" opacity="0.5" stroke="var(--stroke-0, #110000)" strokeLinecap="round" strokeLinejoin="round" strokeOpacity="0.5" strokeWidth="1.5" />
        </g>
      </svg>
    </div>
  );
...
function Weight() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] box-border content-stretch flex font-['Geist:Regular',sans-serif] font-normal h-[36px] items-center justify-between leading-[0] overflow-clip px-[14px] py-[10px] relative rounded-[8px] shrink-0 text-[14px] text-nowrap text-white w-[96px]" data-name="weight">
...
function Component() {
  return (
    <div className="bg-[rgba(0,0,0,0.1)] overflow-clip relative rounded-[9999px] shrink-0 size-[36px]" data-name="Component 2">
      <Check />
    </div>
  );
}
...
function Rows() {
  return (
    <div className="content-stretch flex flex-col gap-px items-center relative shrink-0" data-name="rows">
      <div className="absolute bg-green-900 h-[54px] left-[calc(50%+0.5px)] top-0 translate-x-[-50%] w-[445px]" />
      <div className="absolute bg-green-900 h-[54px] left-[calc(50%+0.5px)] top-[110px] translate-x-[-50%] w-[445px]" />
      <Row />
      <Row1 />
      <Row2 />
    </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Container">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[18px] text-nowrap text-white">
        <p className="leading-[1.3] whitespace-pre">Bulgarian Split Squat</p>
      </div>
      <Rows />
...
function Frame3() {
  return (
    <div className="bg-green-600 box-border content-stretch flex gap-[10px] h-[50px] items-center justify-center overflow-clip px-[27px] py-[14px] relative rounded-[10px] shrink-0 w-[388px]">
