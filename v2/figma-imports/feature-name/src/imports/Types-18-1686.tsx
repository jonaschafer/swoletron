import svgPaths from "./svg-ffy23aemzk";

function Frame2() {
  return (
    <div className="bg-[#172859] box-border content-stretch flex flex-col gap-[10px] h-[36px] items-start justify-center overflow-clip p-[10px] relative rounded-[6px] shrink-0">
...
function Frame8() {
  return (
    <div className="bg-[#1f3a8a] h-[76px] relative rounded-tl-[10px] rounded-tr-[10px] shrink-0 w-full">
      <Frame5 />
...
function Notes() {
  return (
    <div className="content-stretch flex flex-col font-normal gap-[15px] items-start justify-center relative shrink-0 w-full" data-name="notes">
      ...
      <div className="flex flex-col font-['Geist:Regular',sans-serif] justify-center leading-[1.5] relative shrink-0 text-[#f8fafd] text-[16px] w-full">
        <p className="mb-0">Belmont hill repeats</p>
        <p className="mb-0">4-6×90sec @ RPE 7</p>
        <p>2 mi WU/CD</p>
      </div>
    </div>
  );
    ...
    <div className="relative rounded-[6px] shrink-0 w-full" data-name="container">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] items-start pb-[118px] pl-[16px] pr-[20px] pt-[22px] relative w-full">
          <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] opacity-50 relative shrink-0 text-[16px] text-nowrap text-white">
...
function Frame6() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[50px] items-start pb-[70px] pt-[16px] px-[20px] relative shrink-0 w-[343px]">
      <Notes />
      <Notes1 />
    </div>
  );
...
function Frame4() {
  return (
    <div className="bg-gray-700 h-[50px] relative rounded-[10px] shrink-0 w-full">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex gap-[10px] h-[50px] items-center justify-center px-[27px] py-[14px] relative w-full">
          <p className="font-['Geist_Mono:Regular',sans-serif] font-normal leading-[1.3] relative shrink-0 text-[13px] text-nowrap text-white whitespace-pre">Mark complete</p>
        </div>
      </div>
    </div>
  );
...
function Frame7() {
  return (
    <div className="bg-gray-800 box-border content-stretch flex flex-col gap-[10px] items-start pb-[20px] pt-0 px-[20px] relative shrink-0 w-[343px]">
      <Frame4 />
    </div>
  );
}
