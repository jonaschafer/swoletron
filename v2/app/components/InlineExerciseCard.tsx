      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex flex-col items-center">
          <input
            ...
            className="w-16 h-12 text-center text-xl font-semibold border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:outline-none"
            style={{
        ...
        <div className="flex flex-col items-center">
          <input
            ...
            min="0"
          />
          <span className="text-xs text-gray-600 mt-1">Weight</span>
        </div>
        ...
        >
          {isLoading ? (
            ...
            <Check className={`w-4 h-4 ${isLogged ? 'text-white' : 'text-gray-500'}`} />
          )}
        </button>
        </div>
      </div>
